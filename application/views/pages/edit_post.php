		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" onsubmit="pay_attention()" enctype="multipart/form-data" method="post" action="<?=base_url('processamento_edit')?>">
							<div>
