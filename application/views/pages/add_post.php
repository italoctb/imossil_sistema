		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?=base_url('processamento')?>">
							<div>
								<div class="form-group">
									...
									<div class='input-group date col-md-2 col-sm-6 col-xs-12' id='myDatepicker' style="padding-left: 10px">
										<input type='text'  name="date_post" class="form-control"/>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea style="height: 100px" type="text" onkeypress="breakline(this)" id="last-name" name="post" required="required" class="form-control col-md-7 col-xs-12 textarea"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea style="height: 100px" type="text" onkeypress="breakline(this)" id="last-name" name="texto" required="required" class="form-control col-md-7 col-xs-12 textarea"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea style="height: 100px" type="text" onkeypress="breakline(this)" id="last-name" name="comentarios" required="required" class="form-control col-md-7 col-xs-12 textarea"></textarea>
								</div>
							</div>
							<div class="form-group">
